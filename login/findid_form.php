...
error_reporting(0);
 ...
 <meta charset="utf-8">
  ...
  <body style="overflow-x:hidden; overflow-y:auto;">
    <section>
         <div id="login">
          <form name="member_form" action="./findid.php" method="post">
        ...
        <input type=text id="email" name="email" class="inpt" required="required" placeholder="abc@naver.com"  maxlength="80" autocomplete="off" />
