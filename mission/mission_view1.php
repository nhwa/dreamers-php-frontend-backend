...
<div id="ripple">
		<div class="ripple">
			...
			<form name="ripple_form<?=$item_num?>" method="post" action="../mission/insert_ripple.php?&table=<?=$table?>&num=<?=$item_num?>"
				>
			...
			<div id="ripple_writer_title">
				<div class="rrip_title">
					...
					if(($_SESSION['userid']=="admin") || ($_SESSION['userid']==$ripple_id))
								echo "<a href='../mission/delete_ripple.php?table=$table&num=$item_num&ripple_num=$ripple_num'>
					...
					<div id="hidden_ririple<?=$ripple_num?>" class="collapse in">
						<div class="riripple_contentarea">
							<?php
										...
										?>
													<div class="riripple_wrap">
														...
														if(($_SESSION['userid']=="admin") || ($_SESSION['userid']==$riripple_id))
																	echo "<a href='../mission/delete_ripple.php?table=$table&num=$item_num&ripple_num=$riripple_num'>
																	<button type='button' class='merong2'>삭제</button></a>";
														?>
													</div>
							 ...
							 ?>
<!-- 리리플 띄우는 곳 -->
					<form  name="riripple_form<?=$ripple_num?>" class="riripple_form"  method="post" action="../mission/insert_ripple.php?&table=<?=$table?>&num=<?=$item_num?>&group=<?=$group_num?>">
						<div class="form-group">
							<!-- <input type=text name=rep> -->
...
<?php
	...
	// {
?>
				<!-- <a href="../mission/mission_write_form.php?table=<?=$table?>&mode=modify&num=<?=$num?>&page=<?=$page?>">수정하기</a>&nbsp;
				<a href="javascript:del('../mission/mission_delete.php?table=<?=$table?>&num=<?=$num?>')">삭제하기</a>&nbsp; -->
<?php
	// }
?>
<?php
