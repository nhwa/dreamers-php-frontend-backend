...
// 파일 갯수 세자
	...
	for ($i=0; $i<3; $i++)
	{
		...
		// {
			...
			if($image_height[$i]>420)
				{
					$image_height[$i]=420;
					$image_width[$i]=$imageinfo[0]*420/$imageinfo[1];
				}
				else if($image_height[$i]<420)
				{
					$image_height[$i]=420;
					$image_width[$i]=$imageinfo[0]*420/$imageinfo[1];
				}
...
function post(index)
{
  ...
  if(comment && nick)
  {
    ...
    ({
      ...
      {
	    document.getElementsByClassName("ripple_show").innerHTML=response+document.getElementByClassName("ripple_show").innerHTML;
					    ...
					    <ol class="carousel-indicators">
					     ...
					     <div class="carousel-inner" role="listbox">
					       ...
					       <div class="item active">
					         <img src="<?=$img_name ?>" alt="사진" width="<?=$image_width[0]?>" height="<?=$image_height[0]?>" class="img_img">
									 <!-- width="<?=$image_width[0]?>" height="<?=$image_height[0]?>" -->
					       </div>
								 <?php
								 ...
								 if($file_count>1)
								 {
									 for($i=1; $i<$file_count; $i++)
									 {
										 ...
										 ?>
										 <div class="item">
							         <img src="<?=$img_name ?>" alt="사진" width="<?=$image_width[$i]?>" height="<?=$image_height[$i]?>"  class="img_img">
											 <!-- width="<?=$image_width[$i]?>" height="<?=$image_height[$i]?>" -->
							       </div>
									 <?php
									 	}
								 	}
