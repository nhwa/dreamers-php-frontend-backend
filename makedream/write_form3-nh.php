...
<li style="color:#EAEAEA; margin-top: 1px; font-size:13px;">(50MB이하 / PNG,JPG,GIF 형식만 첨부가능)</li><br>
<?php 	if ($mode=="modify" && $item_file[0])
{
	$img_name = $copied_file[0];
	$img_name = "../makedream/data/".$img_name;
?>
<div class="delete_ok"><?php echo $item_file[0]; ?> 파일이 등록되어 있습니다. <input type="checkbox" name="del_file[]" value="0"> 삭제</div>
<div class="clear"></div>
<?php
}
...
{
?>
	<div class="delete_ok"><?php echo $item_file[1]; ?> 파일이 등록되어 있습니다. <input type="checkbox" name="del_file[]" value="1"> 삭제</div>
	<div class="clear"></div>
<?php
}
?>
...
<?php 	if ($mode=="modify" && $item_file[2])
{
?>
	<div class="delete_ok"><?=$item_file[2]?> 파일이 등록되어 있습니다. <input type="checkbox" name="del_file[]" value="2"> 삭제</div>
	<div class="clear"></div>
<?php
}
// 확인용
...
?>
<!-- </div> -->
<button type="button" value="작성하기" class="write"
onclick="submitAction();">작성하기</button>
